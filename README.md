...
[![Go Report Card](https://goreportcard.com/badge/github.com/Jeromeschmidt/makesite)](https://goreportcard.com/report/github.com/Jeromeschmidt/makesite)
...
go build && ./makesite --file=latest-post.txt --dir=text_files
